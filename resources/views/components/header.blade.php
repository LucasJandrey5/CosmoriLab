                            ...
                            <div class="header_search_content">
                                <div class="header_search_form_container">
                                    <form action="#" class="header_search_form clearfix">
                                        <input type="search" required="required" class="header_search_input" placeholder="Procure por músicas, álbuns, compositores...">
                                        <div class="custom_dropdown">
                                            <div class="custom_dropdown_list"> <span class="custom_dropdown_placeholder clc">Todas categorias</span> <i class="fas fa-chevron-down"></i>
                                                <ul class="custom_list clc">
                                                    ...
                                                    <li><a class="clc" href="#">Músicas</a></li>
                                                    <li><a class="clc" href="#">Álbuns</a></li>
